...
<template>
    <div class="w-[35rem] h-screen bg-white flex flex-col">
        ...
        <div id="notifications" class="h-[100%]">
            ...
            <div class="content-toast px-5 mt-4 flex flex-col gap-3">
                <div class="w-full p-4 text-gray-300 bg-blue-ebd rounded-lg shadow-sm " role="alert">
                    <div class="flex">
                        <div
                        ...
                        <div class="ms-3 text-sm font-normal">
                            <span class="mb-1 text-sm font-semibold text-gray-900 dark:text-white">Jhon Doe</span>
                            <div class="mb-2 text-sm font-normal">Usuario anonimo solicitó unirse.</div>
                            <a
                                class="inline-flex px-2.5 py-1.5 text-xs font-medium text-center text-white rounded-lg bg-orange-ebd">Aceptar</a>
                        </div>
                        <button type="button"
